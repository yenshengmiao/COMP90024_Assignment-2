...
for(var i = 0; i < scenario.length; i++){
    scene[scenario[i]["suberb"]] = "Scenario 1: " + "<br>Negative: "+ String(scenario[i]["negative"]) + "<br>Neutral: " + String(scenario[i]["neutral"]) + "<br>Positive: " + String(scenario[i]["positive"]) + "<br>Green Space Visit: " + String(scenario[i]["green_space_visit"]);
}
...
function myMap (){
    ...
    for(i = 0; i < json_mel.length; i++) {
        ...
        if(suburb_name_temp in scene_map && scene_map[suburb_name_temp]["neutral"] !== 0 && scene_map[suburb_name_temp]["negative"] !== 0 && scene_map[suburb_name_temp]["positive"] !== 0) {
